  ...
  return (
    <footer className="bg-blue-900 pt-10 pb-5">
      <section className="container mx-auto px-5 sm:px-7 md:px-10 xl:px-20">
        <h2 className="capitalize text-center text-white font-medium lg:text-xl font-jakarta">
          follow us
        </h2>
        ...
        <nav className="flex items-center justify-center text-white gap-x-1">
          <Link className="text-sm capitalize block" to="privacy-policy">
            privacy policy
          </Link>
          <span>&#x2022;</span>
          <Link className="text-sm capitalize block" to="terms-and-conditions">
            terms & conditions
          </Link>
        </nav>
      </section>
